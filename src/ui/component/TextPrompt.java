...
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
    ...
    public TextPrompt(JTextComponent component) {
        this(component, "", Show.ALWAYS);
    }

    public TextPrompt(JTextComponent component, String text) {
        this(component, text, Show.ALWAYS);
    }

    public TextPrompt(JTextComponent component, String text, Show show) {
